            ...
            <div className="w-[12rem] h-[3rem] ml-[2.5rem] flex text-center content-center items-center rounded-full">
                ...
                >
                    ...
                    >
                        ...
                        <span
                            className={`border border-darkGrayishBlue shadow flex items-center justify-center w-[50%] rounded-full h-[2.3rem] top-[5px]  absolute -z-[12] ${languageToggle ? 'left-[7px]' : 'right-[7px]'}`}
                        ></span>
